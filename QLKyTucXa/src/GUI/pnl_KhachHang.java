...
public class pnl_KhachHang extends javax.swing.JPanel {
    ...
    private void loadData_LoaiSV() {
        DefaultComboBoxModel cbbModel = (DefaultComboBoxModel) cbb_LoaiSV.getModel();
        cbbModel.removeAllElements();
        ResultSet rs = DAO.DAO_LoaiSV.LayLoaiSV();
        try {
            while (rs.next()) {
                Object MaLoaiSV = rs.getString("MaLoaiSV");
                Object TenLoaiSV = rs.getString("TenLoaiSV");
                mycombobox mb = new mycombobox(MaLoaiSV, TenLoaiSV);
    ...
    private void initComponents() {
        ...
        cbb_LoaiSV = new javax.swing.JComboBox<>();
        ...
        txt_TenLoaiSV = new javax.swing.JTextField();
        ...
        cbb_LoaiSV.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
                    ...
                    .addGroup(pnl2Layout.createSequentialGroup()
                        .addGroup(pnl2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnl2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(cbb_LoaiSV, javax.swing.GroupLayout.Alignment.LEADING, 0, 149, Short.MAX_VALUE)
        ...
        pnl2Layout.setVerticalGroup(
            ...
            .addGroup(pnl2Layout.createSequentialGroup()
                ...
                .addGroup(pnl2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lbl_LoaiKH)
                    .addComponent(cbb_LoaiSV, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btn_ThemLoai))
                .addGap(18, 18, 18)
                .addGroup(pnl2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lbl_TenKH)
        ...
        tbl_SV.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        tbl_SV.setGridColor(new java.awt.Color(255, 255, 255));
        tbl_SV.setSelectionBackground(new java.awt.Color(255, 204, 102));
        ...
        txt_TenLoaiSV.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
                        ...
                        .addGroup(pnl3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnl3Layout.createSequentialGroup()
                                ...
                                .addGroup(pnl3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txt_TenLoaiSV, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        ...
        pnl3Layout.setVerticalGroup(
            ...
            .addGroup(pnl3Layout.createSequentialGroup()
                ...
                .addGroup(pnl3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lbl_TenLoai)
                    .addComponent(txt_TenLoaiSV, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(pnl3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lbl_TienGiam)
                    .addGroup(pnl3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btn_SuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SuaActionPerformed
        GanThongTin();
        if (BLL.BLL_SV.KT_Sua(SV)) {
            DAO.DAO_SinhVien.Sua(SV);
            BLL.BLL_SV.dodulieu(tbl_SV);
        }
    }//GEN-LAST:event_btn_SuaActionPerformed
    public static DTO.DTO_SV SV = new DTO_SV();
    public static DTO.DTO_LoaiSV Loai = new DTO.DTO_LoaiSV();

    private void GanThongTin() {
        SV.setMaSV(txt_MaSV.getText());
        GUI.mycombobox mb = (GUI.mycombobox) cbb_LoaiSV.getSelectedItem();
        SV.setMaLoaiSV(mb.value.toString());
        //System.out.println(KH.getMaLoaiKH());
        SV.setTenSV(txt_TenSV.getText());
        SV.setTuoi(txt_Tuoi.getText());
...
//        KH.setCMND(txt_CMND.getText());
        GanThongTin();
        boolean kt = BLL.BLL_SV.KT_Them(SV);
        if (kt) {
            DAO.DAO_SinhVien.Them(SV);
            BLL.BLL_SV.dodulieu(tbl_SV);
        }
    ...
    private void tbl_SVMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_SVMouseClicked
        if (tbl_SV.getSelectedRowCount() == 1) {
            vitri = tbl_SV.getSelectedRow();
            MaSV = tbl_SV.getValueAt(vitri, 0).toString();
            ThongTinChiTiet(MaSV);
            ResultSet rs = DAO.DAO_SinhVien.LaySVMa(MaSV);
    ...
    private void btn_XoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_XoaActionPerformed
        ...
        if (nutbam == JOptionPane.YES_OPTION) {
            int cacdong[] = tbl_SV.getSelectedRows();
            for (int i = 0; i < cacdong.length; i++) {
                String MaKH = tbl_SV.getValueAt(cacdong[i], 0).toString();
                if (BLL.BLL_SV.KT_Xoa(MaKH)) {
                    DAO.DAO_SinhVien.Xoa(MaKH);
                }
            }
            BLL.BLL_SV.dodulieu(tbl_SV);
        }
...
//        }
        ...
        BLL.BLL_LoaiSV.DoDuLieuBang(tbl_LoaiKH);
    ...
    private void GanDuLieuLoai() {
        Loai.setMaLoaiSV(txt_MaLoai.getText());
        Loai.setTenLoaiSV(txt_TenLoaiSV.getText());
    ...
    private void DienDuLieuVaoField(String MaLoai) {
        ResultSet rs = DAO.DAO_LoaiSV.LayTHeoMa(MaLoai);
        try {
            if (rs.next()) {
                txt_MaLoai.setText(rs.getString("MaLoaiSV"));
                txt_TenLoaiSV.setText(rs.getString("TenLoaiSV"));
    ...
    private void btn_Them2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_Them2ActionPerformed
        GanDuLieuLoai();
        if (BLL.BLL_LoaiSV.KT_Them(Loai)) {
            DAO.DAO_LoaiSV.Them(Loai);
            BLL.BLL_LoaiSV.DoDuLieuBang(tbl_LoaiKH);
            LamMoi();
        }
    ...
    private void btn_SuaLoaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SuaLoaiActionPerformed
        GanDuLieuLoai();
        if (BLL.BLL_LoaiSV.KT_Sua(Loai)) {
            DAO.DAO_LoaiSV.Sua(Loai);
            BLL.BLL_LoaiSV.DoDuLieuBang(tbl_LoaiKH);
            LamMoiLoai();
            LamMoi();
        }
    ...
    private void btn_XoaLoaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_XoaLoaiActionPerformed
        ...
        if (nutbam == JOptionPane.YES_OPTION) {
            ...
            for (int i = 0; i < cacdong.length; i++) {
                ...
                if (BLL.BLL_LoaiSV.KT_Xoa(MaLoaiKH)) {
                    DAO.DAO_LoaiSV.Xoa(MaLoaiKH);
                    BLL.BLL_LoaiSV.DoDuLieuBang(tbl_LoaiKH);
                    LamMoi();
                    LamMoiLoai();
                }
    ...
    private void txt_TimKiemKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_TimKiemKeyReleased
      ...
      BLL.BLL_SV.TimKiem(tbl_SV, tukhoa);
    }//GEN-LAST:event_txt_TimKiemKeyReleased
    private void LamMoiLoai() {
        txt_TenLoaiSV.setText("");
        txt_MaLoai.setText("");
    ...
    private void ThongTinChiTiet(String MaSV) {
        ResultSet rs = DAO.DAO_SinhVien.LaySVMa(MaSV);
        try {
            if (rs.next()) {
                txt_MaSV.setText(rs.getString("MaSinhVien"));
                String MaLoai = rs.getString("MaloaiSV");
                DefaultComboBoxModel cbbModel = (DefaultComboBoxModel) cbb_LoaiSV.getModel();
                for (int i = 0; i < cbb_LoaiSV.getItemCount(); i++) {
                    mycombobox mb = (mycombobox) cbbModel.getElementAt(i);
                    if (MaLoai.equals(mb.value)) {
                        cbb_LoaiSV.setSelectedIndex(i);
                    } else {
                    }
                }
                txt_TenSV.setText(rs.getString("TenSinhVien"));
    ...
    public javax.swing.JComboBox<String> cbb_LoaiSV;
    ...
    private javax.swing.JTextField txt_TenLoaiSV;
