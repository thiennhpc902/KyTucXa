...
public class pnl_DSThuePhong extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pnl3.add(btn_ThanhToan, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 610, 470, 42));
        ...
        pnl3.add(txt_TenSV, new org.netbeans.lib.awtextra.AbsoluteConstraints(161, 49, 165, -1));
    ...
    public void DienDuLieuVaoField(String MaDP) {
        ...
        try {
            if (rs.next()) {
                ...
                ResultSet kh = DAO.DAO_SinhVien.LaySVMa(rs.getString("MaSinhVien"));
                if (kh.next()) {
                    txt_TenSV.setText(kh.getString("TenSinhVien"));
                    tenSV = kh.getString("TenSinhVien");
                    ResultSet LoaiSV=DAO.DAO_LoaiSV.LayTHeoMa(kh.getString("MaLoaiSV"));
                    if (LoaiSV.next()) {
                        txt_GiamGia.setText(String.valueOf(LoaiSV.getInt("TienGiam")));
                    }
                }
